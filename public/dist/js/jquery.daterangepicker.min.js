        ...
        function createDom() {
            ...
            if (opt.showTopbar) {
                ...
                if (opt.customTopBar) {
                    ...
                    if (!opt.singleDate) {
                        html += ' <span class="separator-day">' + translate(opt.separator) + '</span> <b class="end-day">...</b> <i class="selected-days">(<span class="selected-days-num">3</span> ' + translate('days') + ')</i>';
                    }
                    html += '</div>';
