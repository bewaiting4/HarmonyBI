            ...
            if (opt.showTopbar) {
                ...
                if (opt.customTopBar) {
                    ...
                    html += '<div class="normal-top">' +
                        '<span>' + translate('selected') + ' </span> <b class="start-day">...</b>';
                    if (!opt.singleDate) {
                        html += ' <span class="separator-day">' + translate(opt.separator) + '</span> <b class="end-day">...</b> <i class="selected-days">'+ (translate("(") || '(') +'<span class="selected-days-num">3</span> ' + translate('days') + (translate(")") || ')') + '</i>';
                    }
                    html += '</div>';
