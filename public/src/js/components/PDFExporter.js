	...
	getConfig(config) {
		...
		_.forEach(config.charts, function(chart, idx){
			if (chart.category === 'echarts' && chart.type !== 'map' && chart.type !== 'network') {
				...
				charts[idx] = window.mapData[chart.id];
			}
		});
        ...
        var dd = {
            ...
            content: [
                ...
                // page 5
                {
                    ...
                    image: charts[2] || 'data:image/png;base64,p0ag6fPAeagd7cf1urFKenQhweXTx33/AONsI5p3f//Z',
                    width: 250,
                    height: 250,
                    margin: [0, singleLineSpacing, 0, singleLineSpacing],
                    alignment: 'center'
                    ...
                    image: charts[3] || 'data:image/png;base64,p0ag6fPAeagd7cf1urFKenQhweXTx33/AONsI5p3f//Z',
                    width: 250,
                    height: 250,
                    margin: [0, singleLineSpacing, 0, singleLineSpacing],
                    alignment: 'center'
